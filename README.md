...
<details><summary>Задание 10. Инвентарь<p></p></summary>
...
Дополнительно: 
- В [UInventoryComponent](./Project_A/Source/Inventory/Public/InventoryComponent.h) есть общий инвентарь и инвентарь экипированных предметов
...
<br> Доработана система, созданная в Задании 9 (выше).
    - Система инвентаря использует следующие элементы:
        - [UInventoryComponent](./Project_A/Source/Inventory/Public/InventoryComponent.h) — имеет 2 инвентаря (обычный и для снаряжения), отвечает за репликацию инвентаря;
        - [UInventory](./Project_A/Source/Inventory/Public/Inventory.h) — реплицируемый UObject, который имеет массив локальных InventorySlots и массив "облегченных" ReplicatedSlots;
        - [FReplicatedSlotArray](./Project_A/Source/Inventory/Public/InventorySlot.h) — массив для передачи содержимого инвентаря по сети, данные восстанавливаются на клиенте, использует функционал FFastArraySerializer;
        - [FInventorySlot](./Project_A/Source/Inventory/Public/InventorySlot.h) — ячейка обычного (локального) инвентаря; 
        - [FInventoryReplicatedSlot](./Project_A/Source/Inventory/Public/InventorySlot.h) — ячейка реплицируемого (облегченного) инвентаря;
        - [UInventoryItem](./Project_A/Source/Inventory/Public/InventoryItem.h) — объект, который можно хранить в UInventory;
        - [UInventoryItemDefinition](./Project_A/Source/Inventory/Public/InventoryItem.h) — описание предмета, который можно хранить в инвентаре;
            <div style="text-align: center;">
...
<br> Минимум для визуализации.        
    - Добавленны следующие элементы:
        - [AGeneralHud](./Project_A/Source/UI/Public/GeneralHud.h) — наследник AHUD, который устанавливается в World;
        - [UBaseWidget](./Project_A/Source/UI/Public/BaseWidget.h) — общий класс для всех виджетов; 
        - [UGeneralWidget](./Project_A/Source/UI/Public/GeneralWidget.h) — основной виджет, который содержит UInventoryWidget и UEquippedItemWidget;
        - [UInventoryWidget](./Project_A/Source/UI/Public/InventoryWidget.h) — для обычного инвентаря; 
        - [UInventorySlotWidget](./Project_A/Source/UI/Public/InventorySlotWidget.h) — для слота обычного инвентаря;
