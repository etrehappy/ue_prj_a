...
2. Скачать [архив (323 MB)](https://drive.google.com/file/d/1B8ij6o_IKOnv9b-GlqSg5GRwD2eSsO2a/view?usp=sharing) и распаковать с заменой в .\ue_prj_a\ 
...
2. Widget здоровья
    - Добавлен [HealthWidget](./Project_A/Source/UI/Public/HealthWidget.h).
    - HealthWidget подписывается на делегат OnHealthChanged [компонента здоровья](./Project_A/Source/Common/Public/HealthComponent.h) у персонажа.
    - Метод [HandleHealthChanged](./Project_A/Source/UI/Private/HealthWidget.cpp) обновляет HpProgressBar и числовое значение здоровья.  
        <div style="text-align: center;">
...
3. Widget после смерти персонажа
    ...
    - Метод ANetPlayerCharacter::[HandleHealthChanged](./Project_A/Source/Project_A/Private/Character/NetPlayerCharacter.cpp) локально показывает окно смерти через метод ACustomPlayerController::[ShowDeathMenu()](./Project_A/Source/Project_A/Private/Character/CustomPlayerController.cpp).
    - ACustomPlayerController подписан на кнопки, которые пользователь может нажать в [UDeathMenuWidget](./Project_A/Source/UI/Public/DeathMenuWidget.h). 
    - Методы ACustomPlayerController::[HandleDeathMenuRespawnRequested](./Project_A/Source/Project_A/Private/Character/CustomPlayerController.cpp) и ACustomPlayerController::HandleDeathMenuExitRequested обрабатывают нажатие кнопок.
        <div style="text-align: center;">
