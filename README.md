...
- [x] Добавлена система жизни — [HealthComponent](./Project_A/Source/Common/Public/HealthComponent.h) (показатель здоровья, смерть)
- [x] Добавлена система получение урона.
    - [WspDamageType](./Project_A/Plugins/WeaponSystemPlugin/Source/WeaponSystemPlugin/Public/WspDamageType.h) — для отслеживания собственных Damage-классов
...
4. Отображение урона
    - Реализовано в виде временного [Actor](./Project_A/Content/Project_A_Root/Blueprints/DamageTest/UI/BP_FloatingDamage.uasset) со своим [WidgetComponent](./Project_A/Content/Project_A_Root/Blueprints/DamageTest/UI/WC_FloatingDamage.uasset), который использует простой текстовый [Widget](./Project_A/Content/Project_A_Root/Blueprints/DamageTest/UI/WBP_TempHealth.uasset).
    - HealthComponent транслирует на сервере о полученном уроне. Персонаж\враг реализует Cosmetic-методы для вызова текстового [Actor](./Project_A/Content/Project_A_Root/Blueprints/DamageTest/UI/BP_FloatingDamage.uasset).
        <div style="text-align: center;">
...
5. Отображение исцеления
    - То же, что для урона. Но при создании текстового [Actor](./Project_A/Content/Project_A_Root/Blueprints/DamageTest/UI/BP_FloatingDamage.uasset) передаются другой цвет, Abs-значение, другая позиция.
6. Анимация смерти
